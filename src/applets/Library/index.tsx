...
/**
 * src/applets/Library/index.tsx — the Library OVERRIDE module (D-11,
 * 04-02-PLAN.md Task 2). Registered in registry.ts as an override entry
 * (after the templatedModules spread) so a future rich Library port
 * (Plan 03/04) only ever edits THIS file's `App` — registry.ts and
 * templated.ts never change.
 *
...
const rows = demoRows.Library ?? genericDemoRow;
