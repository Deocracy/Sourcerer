 ...
 * data-tauri-drag-region element, T-02-02) -> LayoutsMenu (D-01, PERS-02) ->
 * RailToggleButtons -> WindowControls. The spacer shrinks as chrome fills in
 * but must remain the sole drag region — no chip or button carries it.
 */
