...
**Naming (user, 2026-07-15, sketch 002 feedback):** the program's title-bar wordmark reads **Databasise**, not Sourcerer. All sketches use the Databasise wordmark.
...
| 006 | settings | Corpus settings vs app settings — one place or two? | A — one settings screen, sidebar sectioned App / Corpus | settings, providers, tiers |
