...
Plans:
**Wave 1**
- [x] 03-01-PLAN.md — Install plugin-store + unified WorkspaceRecordV1 backend (schema, load/migrate/default, single debounced writer); package legitimacy gate
**Wave 2** *(blocked on Wave 1)*
...
- [x] 06-01-PLAN.md — Shell-store foundation slice (asstWidth/assistantOpen persisted + homeOpen/lastResolvedProposal/pendingCardMint session-only) + WorkspaceRecordV1 schema (ASST-03/HOME-01)
- [x] 06-02-PLAN.md — ASST-01 multi-session vertical slice: session list (real + seeded transcripts), header chrome, ⌘↵ streamed send + all --asst-* tokens (ASST-01)
**Wave 2** *(parallel — disjoint files)*
- [x] 06-03-PLAN.md — ASST-02 proposals: client-side proposalParse + serif-italic quote block + y/d/n + ＋MAKE CARD producer (ASST-02)
...
| 6. Dashboard Assistant & Home | 8/8 | Complete    | 2026-07-14 |
